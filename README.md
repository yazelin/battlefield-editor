...
- **首頁戰場列表**:https://yazelin.github.io/battlefield-editor/ (gallery,列出所有戰場)
...
```
index.html              首頁戰場列表 gallery(GitHub Pages 首頁;讀 packages/index.json 列出各戰場)
...
# 開 http://localhost:8080/                                        → 戰場列表(gallery)
...
```bash
node tools/editor-server.mjs          # http://localhost:8090(首頁=戰場列表)
